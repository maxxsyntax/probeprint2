...
#
# Usage:
#   ./analysis-scripts/seqgraph.sh              assign device ids to unassigned frames
#   ./analysis-scripts/seqgraph.sh --recompute  rebuild the graph over every frame
#   ./analysis-scripts/seqgraph.sh --report     devices, their PNLs and confidence
#   ./analysis-scripts/seqgraph.sh --validate   measure accuracy against static MACs
#   ./analysis-scripts/seqgraph.sh --pnl        rebuild device_ssid only
#
# Tuning, via .env:
