...
#
# Usage:
#   ./standalone_language.sh              classify rows with no language yet
#   ./standalone_language.sh --recompute  reclassify everything
#   ./standalone_language.sh --report     what was found, and what script
#                                         detection found for comparison
[ -f .env ] && source .env
source ./language_functions.sh
